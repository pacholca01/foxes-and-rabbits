Module 5: The "Client" has a request

As the client I need the team to "reverse engineer" the Fox and Rabbit simulation and tweek it to make the Ecosystem simulation.
Chapter 12 - pages 417 thru 442
